...
class Offer:
    ...
    def __init__(self, carrier_id, offer_id, loc_pickup, loc_dropoff, revenue, min_price, winning_bid="NONE", winner="NONE"):
    ...
    def get_second_highest_bid(self):
        if not self.bids.values():
            ...
            if second_highest_bid <= self.min_price:
    ...
    def get_highest_bid(self):
        if not self.bids.values():
            ...
            if highest_bid[1] <= self.min_price:
                return False
            return highest_bid
